...
<span class="line">    }</span>
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>优缺点总结：</strong></p><ul><li><strong>优点</strong>：<strong>性能极高</strong>。增加任务的时间复杂度是 O(1)，非常适合每秒百万级的超时任务（如网络连接空闲检测）。</li><li><strong>缺点</strong>：精度取决于 tickDuration；任务是在内存中，不支持持久化（进程挂了任务就没了）。</li></ul><p><img src="`+l+'" alt="四种延迟任务方案对比图"></p>',50)])])}const p=n(d,[["render",r]]),o=JSON.parse('{"path":"/blogs/Javashixianyanchirenwudesizhongfangan：congDelayQueuedaoshijianlunsuanfa.html","title":"Java实现延迟任务的四种方案：从DelayQueue到时间轮算法","lang":"zh-CN","frontmatter":{"title":"Java实现延迟任务的四种方案：从DelayQueue到时间轮算法","date":"2026-04-03T00:00:00.000Z","categories":["Java","架构设计","中间件"],"tags":["Java","Redisson","RocketMQ","Netty","延迟队列","时间轮"],"author":"剑桥折刀"},"headers":[{"level":3,"title":"1. JDK 原生方案：DelayQueue","slug":"_1-jdk-原生方案-delayqueue","link":"#_1-jdk-原生方案-delayqueue","children":[]},{"level":3,"title":"2. 分布式方案：Redisson","slug":"_2-分布式方案-redisson","link":"#_2-分布式方案-redisson","children":[]},{"level":3,"title":"3. 消息中间件方案：RocketMQ","slug":"_3-消息中间件方案-rocketmq","link":"#_3-消息中间件方案-rocketmq","children":[]},{"level":3,"title":"4. 高性能算法方案：时间轮 (HashedWheelTimer)","slug":"_4-高性能算法方案-时间轮-hashedwheeltimer","link":"#_4-高性能算法方案-时间轮-hashedwheeltimer","children":[]}],"git":{"createdTime":1775228292000,"updatedTime":1776256994000,"contributors":[{"name":"剑桥折刀","email":"3144253125@qq.com","commits":6}]},"filePathRelative":"blogs/Java实现延迟任务的四种方案：从DelayQueue到时间轮算法.md"}');export{p as comp,o as data};
