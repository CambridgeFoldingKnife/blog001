import{_ as p,c as l,d as i,e as n,f as a,b as t,w as c,r as o,o as r}from"./app-BCJA8XSU.js";const d={};function u(k,s){const e=o("RouteLink");return r(),l("div",null,[s[3]||(s[3]=i(`<h1 id="docker实战应用" tabindex="-1"><a class="header-anchor" href="#docker实战应用"><span>Docker实战应用</span></a></h1><h2 id="一、容器化部署-spring-boot-应用" tabindex="-1"><a class="header-anchor" href="#一、容器化部署-spring-boot-应用"><span>一、容器化部署 Spring Boot 应用</span></a></h2><h3 id="_1-1-准备-spring-boot-项目" tabindex="-1"><a class="header-anchor" href="#_1-1-准备-spring-boot-项目"><span>1.1 准备 Spring Boot 项目</span></a></h3><p><strong>创建简单的 Spring Boot 项目：</strong></p><div class="language-java line-numbers-mode" data-highlighter="prismjs" data-ext="java" data-title="java"><pre><code><span class="line"><span class="token comment">// src/main/java/com/example/demo/DemoApplication.java</span></span>
