import{_ as l,c as i,d as p,e as n,f as a,b as c,w as t,r,o as d}from"./app-BXKg5Fxk.js";const o={};function v(u,s){const e=r("RouteLink");return d(),i("div",null,[s[3]||(s[3]=p(`<h1 id="docker核心概念" tabindex="-1"><a class="header-anchor" href="#docker核心概念"><span>Docker核心概念</span></a></h1><h2 id="一、docker镜像原理" tabindex="-1"><a class="header-anchor" href="#一、docker镜像原理"><span>一、Docker镜像原理</span></a></h2><h3 id="_1-1-镜像的本质" tabindex="-1"><a class="header-anchor" href="#_1-1-镜像的本质"><span>1.1 镜像的本质</span></a></h3><p>Docker 镜像是一个<strong>只读的文件系统</strong>，包含了运行应用所需的所有内容：</p><ul><li>代码</li><li>运行时环境</li><li>系统工具</li><li>系统库</li><li>配置文件</li></ul><p><strong>镜像 = 文件系统快照 + 启动命令</strong></p><h3 id="_1-2-分层存储-union-fs" tabindex="-1"><a class="header-anchor" href="#_1-2-分层存储-union-fs"><span>1.2 分层存储（Union FS）</span></a></h3><p>Docker 镜像采用**联合文件系统（Union File System）**技术，实现分层存储：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">┌─────────────────────────────────┐</span>
