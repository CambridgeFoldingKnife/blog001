import{_ as l,c as i,d as c,e as n,f as a,b as p,w as t,r as d,o as r}from"./app-Db1GWNE9.js";const o={};function v(m,s){const e=d("RouteLink");return r(),i("div",null,[s[3]||(s[3]=c(`<h1 id="docker基础入门" tabindex="-1"><a class="header-anchor" href="#docker基础入门"><span>Docker基础入门</span></a></h1><h2 id="一、docker是什么" tabindex="-1"><a class="header-anchor" href="#一、docker是什么"><span>一、Docker是什么？</span></a></h2><h3 id="_1-1-docker简介" tabindex="-1"><a class="header-anchor" href="#_1-1-docker简介"><span>1.1 Docker简介</span></a></h3><p><strong>Docker</strong> 是一个开源的容器化平台，它可以让开发者将应用及其依赖打包到一个轻量级、可移植的容器中，然后发布到任何流行的 Linux 或 Windows 机器上。</p><p><strong>Docker 的核心价值：</strong></p><ul><li>🚀 <strong>快速部署</strong> - 秒级启动，比虚拟机快得多</li><li>📦 <strong>环境一致</strong> - &quot;在我机器上能跑&quot;的问题彻底解决</li><li>🔄 <strong>轻量级</strong> - 共享主机内核，资源占用少</li><li>🌍 <strong>跨平台</strong> - 一次构建，到处运行</li></ul><h3 id="_1-2-为什么要用docker" tabindex="-1"><a class="header-anchor" href="#_1-2-为什么要用docker"><span>1.2 为什么要用Docker？</span></a></h3><p><strong>传统部署的痛点：</strong></p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">问题1：环境不一致</span>
