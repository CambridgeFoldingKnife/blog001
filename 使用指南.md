...
export default defineUserConfig({
  base: '/Cambridge Folding Knife-Blog/',  // 仓库名
  // ...
})
```
...
如有问题，欢迎通过 [邮件](mailto:3144253125@qq.com) 或 [GitHub Issues](https://github.com/CambridgeFoldingKnife/YIXUAN-Blog/issues) 联系我！
