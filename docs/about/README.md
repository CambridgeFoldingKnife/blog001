...
<div class="profile-header">
  <div class="avatar-section">
    ...
    <h2>剑桥折刀 (Cambridge Folding Knife)</h2>
...
<div class="contact-cards">
  <div class="contact-card">
    ...
    <h3>Email</h3>
    <a href="mailto:3144253125@qq.com">3144253125@qq.com</a>
  </div>
  
  <div class="contact-card">
    <div class="contact-icon">🐙</div>
    <h3>GitHub</h3>
    <a href="https://github.com/CambridgeFoldingKnife" target="_blank">@CambridgeFoldingKnife</a>
  </div>
...
<div style="text-align: center; margin-top: 50px;">
  ...
  <p style="margin-top: 30px;">
    <a href="mailto:3144253125@qq.com" style="
