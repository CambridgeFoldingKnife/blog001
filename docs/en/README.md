...
bannerBrand:
  ...
  buttons:
    - { text: Start Reading, link: '/blog001/posts.html' }
    - { text: Tutorials, link: '/blog001/tutorials/', type: 'plain' }
  socialLinks:
...
footer:
  record: MIT License
  recordLink: 'https://github.com/CambridgeFoldingKnife/YIXUAN-Blog'
  cyberSecurityRecord: Cambridge Folding Knife's Blog
...
<img src="/avatar.png" alt="Cambridge Folding Knife" />
...
<div class="profile-name">Cambridge Folding Knife</div>
<button class="close-btn" id="closeBtn">✕</button>
</div>

<!-- Social links -->
<div class="profile-social">
<a href="mailto:3144253125@qq.com" class="social-link" title="Send Email">
<span class="social-icon">📧</span>
<span class="social-text">Email</span>
</a>
<a href="https://github.com/CambridgeFoldingKnife" target="_blank" class="social-link" title="Visit GitHub">
<span class="social-icon">🐙</span>
...
<a href="mailto:3144253125@qq.com" class="contact-btn">
<span class="btn-icon">📧</span>
<span class="btn-text">Email</span>
</a>
<a href="https://github.com/CambridgeFoldingKnife" target="_blank" class="contact-btn">
<span class="btn-icon">🐙</span>
...
<a href="https://github.com/CambridgeFoldingKnife/YIXUAN-Blog" target="_blank" class="cta-btn primary">⭐ Star Support</a>
